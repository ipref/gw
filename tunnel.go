...
func (mgw *MapGw) get_src_ipref(ip IP) (IpRef, bool) {
	...
	if cli.test_mapper {
		...
		switch ip {
		case MustParseIP(ea_prefix + "192.168.97.11"):
			return IpRef{MustParseIP(gw_prefix + "192.168.11.97"), MustParseRef("1-0711")}, true
		case MustParseIP(ea_prefix + "192.168.98.22"):
			return IpRef{MustParseIP(gw_prefix + "192.168.12.98"), MustParseRef("2-0822")}, true

		// TODO Hard-coded reference to associate with the address assigned to
		// the tun device. This allows ICMP packets generated by the network
		// stack to be recognized.
		case cli.ea_ip:
			return IpRef{cli.gw_ip, MustParseRef("1")}, true
		}
		return IpRef{}, false
	}
...
func (mgw *MapGw) get_dst_ipref(ip IP) (IpRef, bool) {
	...
	if cli.test_mapper {
		...
		switch ip {
		case MustParseIP(ea_prefix + "10.248.22.222"):
			return IpRef{MustParseIP(gw_prefix + "192.168.12.98"), MustParseRef("2-0822")}, true
		case MustParseIP(ea_prefix + "10.248.22.224"):
			return IpRef{MustParseIP(gw_prefix + "192.168.12.98"), MustParseRef("2-0824")}, true
		case MustParseIP(ea_prefix + "10.255.11.111"):
			return IpRef{MustParseIP(gw_prefix + "192.168.11.97"), MustParseRef("1-0711")}, true
		}
		return IpRef{}, false
	}
...
func (mtun *MapTun) get_src_addr(src IpRef) (IP, bool) {
	...
	if cli.test_mapper {
		...
		case MustParseIpRef(gw_prefix + "192.168.11.97 + 1-0711"):
			return MustParseIP(ea_prefix + "10.255.11.111"), true
		case MustParseIpRef(gw_prefix + "192.168.12.98 + 2-0822"):
			return MustParseIP(ea_prefix + "10.248.22.222"), true
		case MustParseIpRef(gw_prefix + "192.168.12.98 + 2-0824"):
			return MustParseIP(ea_prefix + "10.248.22.224"), true

		// TODO Hard-coded reference associated with the addresses assigned to
		// the tun devices. This allows ICMP communication with the network
		// stack.
		case MustParseIpRef(gw_prefix + "192.168.11.97 + 1"):
			return MustParseIP(ea_prefix + "10.255.11.1"), true
		case MustParseIpRef(gw_prefix + "192.168.12.98 + 1"):
			return MustParseIP(ea_prefix + "10.248.22.1"), true
		}
		return IP{}, false
	}
...
func (mtun *MapTun) get_dst_addr(dst IpRef) (IP, bool) {
	...
	if cli.test_mapper {
		...
		switch dst {
		case MustParseIpRef(gw_prefix + "192.168.11.97 + 1-0711"):
			return MustParseIP(ea_prefix + "192.168.97.11"), true
		case MustParseIpRef(gw_prefix + "192.168.12.98 + 2-0822"):
			return MustParseIP(ea_prefix + "192.168.98.22"), true

		// TODO Hard-coded reference to associate with the address assigned to
		// the tun device. This allows ICMP communication with the network
		// stack.
		case IpRef{cli.gw_ip, MustParseRef("1")}:
